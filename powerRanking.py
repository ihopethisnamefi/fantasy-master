...
sqlCount = 1
for manager in managers:
    sqlString=str(sqlCount)
    print('INSERT INTO rankings (manager, week, year, ranking, description) VALUES ("' + getManager(sqlCount) + '", ' + weekString + ', ' + str(year) + ', ' + sqlString + ', "' + getDescription(sqlCount) + '");')
    sqlCount = sqlCount + 1
